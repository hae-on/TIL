...
for i in movie:
    director = Director.objects.get(id=i.director_id)
    genre = Genre.objects.get(id=i.genre_id)

    print(director, genre, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in movie:
    ...
    print(director.name, genre, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in movie:
    ...
    print(director.name, genre.title, i.genre_id, i.title, i.opening_date, i.running_time, i.screening)
```
...
for i in movie:
    print(f'{i.director.name} {i.genre.title} {i.title} {i.opening_date} {i.running_time} {i.screening}')
```
...
```python
movie = Movie.objects.order_by('opening_date').filter(screening = 1)
